...
En este caso, vuelve a realizar la comunicación entre procesos pero usando tuberías (Pipe),
 ...
 al proceso que se encarga de la suma. El proceso que suma los números tiene que recibir 
 (recv) un número y realizar la suma. Una vez que el proceso que lee el fichero termine de
